...
from .views import ProductListAPIView, ProductDetailAPIView,AnonymousCartAPIView,AddToCartAPIView,UpdateCartItemAPIView,RemoveFromCartAPIView,CartRetrieveDeleteAPIView, OrderListAPIView,OrderDetailAPIView,CreateCheckoutSessionAPIView,RegisterUserAPIView, UserMeView, HistoryOrdersAPIView, AuthenticatedCartCreateAPIView

urlpatterns = [
    path('products/', ProductListAPIView.as_view(), name='product-list'),
    path('products/<int:pk>/',ProductDetailAPIView.as_view(), name='product-detail'),
    path('cart/anonymous/', AnonymousCartAPIView.as_view(), name='cart-anonymous'),
